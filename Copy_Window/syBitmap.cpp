...
{
	// DC -> DC
	float fWidth = rtDesk.right * m_fScale;
	float fHeight = rtDesk.bottom * m_fScale;
	float fX = rtDesk.left - (fWidth / 2 - rtDesk.right / 2);
	float fY = rtDesk.top - (fHeight / 2 - rtDesk.bottom / 2);
